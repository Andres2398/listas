...
public class Lista6Version {
	...
	public void sacar() {
		...
		cabecera.getPrimero().getPosicionAnterior().setSiguienteElemento(cabecera.getPrimero().getSiguienteElemento());;
		cabecera.setPrimero(cabecera.getPrimero().getSiguienteElemento());
